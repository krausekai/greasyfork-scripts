...
function main() {
	...
	if (document.body) {
		...
		for (var i = 0; i < iframes.length; i++) {
			var iframeSrc = /\<iframe.+src\=\"(.+)\"/igm.exec(iframes[i]);
