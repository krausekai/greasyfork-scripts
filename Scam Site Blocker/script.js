...
function main() {
	...
	var keywords = ["error", "security", "warning", "warnung", "official", "support", "hotline", "virus", "infected", "infection", "blocked", "alert", "notification"];
