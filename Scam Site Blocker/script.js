...
var redFlags = 0; // definite detections
var yellowFlags = 0; // suspicious detections - become red flags once a red flag is detected
...
function main() {
	...
	// Block bad URL terms
	var badUrlTerms = ["call-now1", "call-now2", "firiedge", "ffiedge", "/processdll/", "jook.html", "chr-win-error", "Call-for-SecurityCH-Issues18", "AFUK1404", "systemerror-win-chx", "Call-Windows-Support_IEDGE"];
	...
	var openers = scripts.split(")");
	var openerSrcs = [];
	for (var i = 0; i < openers.length; i++) {
		var openerSrc = /window\.open.+(\"|\')\,"/igm.exec(openers[i]);
