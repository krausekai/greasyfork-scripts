Redirect broadcasts to the popout version to save CPU usage.

Also see: <a href="https://greasyfork.org/en/scripts/371309-twitch-redirect-videos-vods-to-popout-player-version">Twitch - Redirect Videos (VoDs) to Popout Player Version</a>.
